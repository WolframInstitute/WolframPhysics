...
- [`OrientedGraph`](https://github.com/maxitg/OrientedGraph) (OrientedGraph) a planar network system as an oriented graph, a graph with the given edges whose vertices carry cyclically ordered ports
...
- [`VertexPort`](https://github.com/maxitg/OrientedGraph/blob/master/OrientedGraph.wl) (OrientedGraph) a port of a vertex of an oriented graph, the outlet an edge connects to
- [`GraphPort`](https://github.com/maxitg/OrientedGraph/blob/master/OrientedGraph.wl) (OrientedGraph) an outgoing free port of an oriented graph
...
- [`OrientedGraphQ`](https://github.com/maxitg/OrientedGraph/blob/master/OrientedGraph.wl) (OrientedGraph) whether an expression is an oriented graph

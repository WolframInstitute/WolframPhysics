...
- [`MultispacePlot3D`](https://resources.wolframcloud.com/FunctionRepository/resources/MultispacePlot3D/) (WFR) the multiway evolution of a nondeterministic machine embedded in three dimensions on timelike, spacelike and branchlike axes
- [`TMAppliesMultispace`](https://www.wolframcloud.com/obj/sw-blog/MultiwayTuringMachines/Programs-01.wl) (Writings) the applies graph of one rule drawn in three dimensions with head position as the extra coordinate, the published [`MultispacePlot3D`](https://resources.wolframcloud.com/FunctionRepository/resources/MultispacePlot3D/) covers it
...
- [`CausalInvariantQ`](https://resources.wolframcloud.com/FunctionRepository/resources/CausalInvariantQ/) (WFR) whether a multiway system is causal invariant after a number of steps from an initial condition
- [`CyclicTMCausalInvariantQ`](https://www.wolframcloud.com/obj/sw-blog/MultiwayTuringMachines/Programs-01.wl) (Writings) whether a multiway machine on a cyclic tape is causally invariant, branch pairs whose out-components overlap counted as resolved
- [`TuringMachineGlocalBranchialGraph`](https://resources.wolframcloud.com/FunctionRepository/resources/TuringMachineGlocalBranchialGraph/) (WFR) the branch pair ancestry of a nondeterministic Turing machine glocal multiway system
...
- [`$LambdaBusyBeavers`](https://github.com/WolframInstitute/WolframLambda/blob/main/Kernel/Lambda.wl) (Wolfram/Lambda) the known lambda calculus busy beavers as terms with de Bruijn indices, the counterpart of the Turing machine records
...
- [`NDTMEvolution`](https://www.wolframcloud.com/obj/sw-blog/MultiwayTuringMachines/Programs-01.wl) the states of a nondeterministic machine step by step, the leaves of the multiway states graph, the published [`MultiwayTuringMachine`](https://resources.wolframcloud.com/FunctionRepository/resources/MultiwayTuringMachine/) covers it

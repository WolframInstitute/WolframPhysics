...
- [`LocalDimensionality`](https://github.com/maxitg/OrientedGraph/blob/master/OrientedGraph.wl) (OrientedGraph) the dimensionality near a vertex of an oriented graph, from the growth of a ball of a given radius
...
- [`GraphRandomWalk`](https://resources.wolframcloud.com/FunctionRepository/resources/GraphRandomWalk/) (WFR) a discrete or continuous time random walk on a graph, the return probabilities a spectral dimension is read from
...
- [`FaceVector`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) (WolframInstitute/Infrageometry) the f-vector of a simplicial complex, the count of faces in each dimension
...
- [`OrientedGridGraph`](https://github.com/maxitg/OrientedGraph/blob/master/OrientedGraph.wl) (OrientedGraph) the oriented grid graph with a given number of vertices in each direction, optionally wrapped around into a torus
...
- [`HVector`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl), [`GVector`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) the h-vector of a complex, derived from its f-vector, and the g-vector of its first differences
...
- [`InducedSubcomplex`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl), [`VertexDeletion`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) the subcomplex induced on a vertex subset, and a complex with a vertex and its incident simplices removed
- [`ComplexUnion`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl), [`ComplexIntersection`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl), [`ComplexDifference`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) the closure of the union of two complexes, the simplices they share, and the closure of the simplices of one not in the other
- [`FacetGraph`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl), [`PureComplexQ`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) the dual graph of the facets of a complex, adjacent when they share a ridge, and whether every facet has the same dimension
...
- [`HodgeLaplacianMatrix`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Infrageometry.wl) the square of the Dirac operator, the Hodge Laplacian of the complex
...
- [`BettiAssociation`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl), [`EulerBettiConsistencyQ`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) the Betti numbers of a complex keyed by dimension, and whether their alternating sum equals its Euler characteristic
- [`MeshComplex`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl), [`ComplexMesh`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl), [`GraphMesh`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl) the simplicial complex a mesh region induces, a mesh region built from a complex with optional coordinates, and a mesh region built from a graph embedding and its cliques up to size four
- [`MeshIncidenceMatrix`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl) the oriented incidence matrix between the cells of a mesh in adjacent dimensions
- [`OrientMeshRegion`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl), [`OrientableMeshRegionQ`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl) a mesh with its top dimensional cells oriented consistently, and whether such an orientation exists, tested through the connectivity of its oriented adjacency
- [`HighlightComplex`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl) a complex drawn as a mesh with chosen simplices highlighted
...
- [`TriangularLatticeGraph`](https://resources.wolframcloud.com/FunctionRepository/resources/TriangularLatticeGraph/) the graph of a triangular lattice, a flat two-dimensional test space
...
- [`SimplicialHomologyGroup`](https://resources.wolframcloud.com/FunctionRepository/resources/SimplicialHomologyGroup/) the homology groups of a simplicial complex, the Betti numbers and torsion of a complex built on a hypergraph
...
- [`CurvedSpacetimeRegionSprinkling`](https://resources.wolframcloud.com/FunctionRepository/resources/CurvedSpacetimeRegionSprinkling/) random causal graphs from sprinkling points into a specified region of a curved spacetime
...
- [`HGMinkowskiSprinkling`](https://github.com/WolframInstitute/HypergraphRewritingEngine/blob/master/paclet/Kernel/HypergraphRewriting.wl) a causal set generated by sprinkling into Minkowski spacetime

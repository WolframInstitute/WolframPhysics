...
- [`MeshIncidenceMatrix`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Mesh.wl) (WolframInstitute/Infrageometry) the oriented incidence matrix between consecutive cell dimensions of a mesh, the coboundary in each degree
- `KirchhoffMatrix` (WL) the graph Laplacian, the Hodge Laplacian on functions of the trivial connection
- [`DiscreteDirichletEnergy`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Experimental.wl) (WolframInstitute/Infrageometry) the Dirichlet energy of a function on the vertices of a graph or complex, half the sum of its squared differences over edges
...
- [`DiracHodgeMatrix`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Infrageometry.wl) the Dirac operator of a simplicial complex, its boundary operator plus the transpose
...
- [`HodgeMatrix`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Infrageometry.wl) the Hodge Laplacian of a complex split into its blocks by dimension, the square of the Dirac operator
...
- [`SuperTrace`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Infrageometry.wl) the graded trace of a block matrix, the traces of its blocks with alternating signs
- [`PseudoDeterminant`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Infrageometry.wl) the product of the nonzero eigenvalues of a matrix
- [`SuperDeterminant`](https://github.com/WolframInstitute/Infrageometry/blob/main/Infrageometry/Kernel/Infrageometry.wl) the graded determinant of a block matrix from the pseudo-determinants of its blocks
...
- [`GraphSources`](https://github.com/WolframInstitute/InfraAnalysis/blob/main/InfraAnalysis/Kernel/Usage.wl) the source vertices of a directed graph, those with no incoming edge, where integration along the graph begins
- [`GraphSinks`](https://github.com/WolframInstitute/InfraAnalysis/blob/main/InfraAnalysis/Kernel/Usage.wl) the sink vertices of a directed graph, those with no outgoing edge, where integration along the graph ends
...
- [`CohomologyGroups`](https://www.wolframcloud.com/obj/wolframinstitute/DeployedResources/Paclet/WolframInstitute/PureMath/Documentation/ref/CohomologyGroups.html) the integer cohomology groups of a complex in each degree, with their torsion
